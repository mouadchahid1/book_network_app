...
export class AuthenticationService extends BaseService {
  ...
  getUsernameFromToken() {
    ...
    if (token) {
      ...
      const decodeToken = jwtHelper.decodeToken(token as string);
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  authenticate$Response(params: Authenticate$Params, context?: HttpContext): Observable<StrictHttpResponse<AuthenticateResponseDto>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  authenticate(params: Authenticate$Params, context?: HttpContext): Observable<AuthenticateResponseDto> {
    return this.authenticate$Response(params, context).pipe(
      map((r: StrictHttpResponse<AuthenticateResponseDto>): AuthenticateResponseDto => r.body)
    );
  }
